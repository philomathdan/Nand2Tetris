...
My approach to writing this program was to write out the assembly code for each possible VM code line, and then write python functions for producing these.  Because of all the overlap in the various assembly code groups, I used four functions: math operations, (in)equalities, push, and pop.  Along the way I came across a couple of sticky issues, namely:
