...
In this directory are my HDL files and my sketches for each gate (though I didn't make sketches for Not16, Or16, And16, or Mux16 since those are just the single bit versions repeated over and over.) In most of the HDL files, I added some comments about my thought process for finding a solution.
